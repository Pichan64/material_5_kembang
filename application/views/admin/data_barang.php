    ...
    <table class="table table-bordered">
        ...
        foreach ($barang as $brg) : ?>
            ...
            <tr>
                ...
                <td>
                    <?php echo anchor('admin/data_barang/edit/' . $brg->id_brg, '<div class="btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?>
                </td>
                <td>
                    <?php echo anchor('admin/data_barang/hapus/' . $brg->id_brg, '<div class="btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?>
                </td>
            </tr>
