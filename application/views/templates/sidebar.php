    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('welcome') ?>">
                ...
                <div class="sidebar-brand-text mx-3">Material 5 kembang</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/tambahan') ?>">
                    <i class="fas fa-building"></i>
                    <span>Tambahan</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/cat') ?>">
